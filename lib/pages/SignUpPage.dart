...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void kaydetFirestore(String email, String password, String userName, String userType) async {
    try {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    reusableTextField("Kullanıcı Adı", Icons.person_outline, false, _userNameTextController),
                    const SizedBox(
                      height: 20,
                    ),
                    reusableTextField("E - Mail", Icons.mail_outline_rounded, false, _emailTextController),
                    const SizedBox(
                      height: 20,
                    ),
                    reusableTextField("Parola", Icons.lock_outlined, true, _passwordTextController),
                    const SizedBox(
                      height: 20,
                    ),
                    Container(
